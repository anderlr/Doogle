...
{
    $result = array();
    $result[] = array('caption' => 'Animal Encontrado', 'short_caption' => 'Animal Encontrado', 'filename' => 'animal_encontrado.php', 'name' => 'animal_encontrado', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Animal Procurado', 'short_caption' => 'Animal Procurado', 'filename' => 'animal_procurado.php', 'name' => 'animal_procurado', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Nivel Acesso', 'short_caption' => 'Nivel Acesso', 'filename' => 'nivel_acesso.php', 'name' => 'nivel_acesso', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
...
<span class="navbar-brand">
    ...
    <span>
        ...
        <img src="doogle_logo.png" style="height: 44px; margin-top: -14px;">
...
<span class="navbar-brand">    
    ...
    <span class="hidden-xs"><strong>Sistema Doogle - Release 2.0 </strong></span>
